...
output_filename = 'addressgeo.csv'
...
def get_google_results(address, api_key='ENTERYOURAPIKEYHERE', return_full_response=False):
    """
...
df.head()
#writeToCSV
df.to_csv('address.csv',encoding='utf8')
#readCSV
newdf = pd.read_csv('address.csv')
newdf.shape
